...
namespace JustSaying.AwsTools.MessageHandling
{
    public abstract class SnsTopicBase : IMessagePublisher
    {
        ...
        protected SnsTopicBase(IMessageSerialisationRegister serialisationRegister, ILoggerFactory loggerFactory, Func<Type, string> getMessageTypeString)
        {
        ...
        private PublishRequest BuildPublishRequest(Message message)
        {
            ...
            var messageType = _getMessageTypeString(message.GetType());
